...
public class BadWordUtil2 {
    public static String filePath = "CensorWords.txt";//敏感词库文件路径
    ...
    public static Set<String> readTxtByLine(String path) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        String string = "太多的伤感情怀三级也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
